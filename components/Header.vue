...
<template>
    <div class="mt-2 fixed top-0 left-0 right-0 mx-auto container">
        <Menubar :model="items">
            <template #start>
            ...
            <template #end>
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        <Button icon="pi pi-sun" v-if="isDark" @click="toggleColorScheme" severity="secondary" rounded
                            aria-label="light" />
                        <Button icon="pi pi-moon" v-if="!isDark" @click="toggleColorScheme" severity="secondary" rounded
                            aria-label="dark" />
                    </div>
                </div>
            </template>
